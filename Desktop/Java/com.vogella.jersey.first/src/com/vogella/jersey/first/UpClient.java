...
public class UpClient {
  ...
  /*public static void initialProperties(Client client)
  {
    ...
    response = client.target("http://localhost:8080/com.vogella.jersey.first/services/propertys").request()
  ...
  //}
	...
	public static void newProperty(Client client, Scanner scan)
	{
	  ...
	  Response response = client.target("http://localhost:8080/com.vogella.jersey.first/services/propertys").request().post(Entity.xml(xml));
